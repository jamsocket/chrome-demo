...
use crate::websocket::{BrowserAction, SendScreenshot, SendUrl, WebsocketConnection};
use actix::{Actor, Addr, AsyncContext, Context, Handler, Message};
use headless_chrome::{Browser, LaunchOptions, Tab, browser::{default_executable, tab::{get_key_definition, point::Point}}, protocol::{page::ScreenshotFormat}};
...
pub struct BrowserActor {
    listeners: Vec<Addr<WebsocketConnection>>,
    _browser: Browser,
    tab: Arc<Tab>,
    screen_data: Vec<u8>,
    url: String,
